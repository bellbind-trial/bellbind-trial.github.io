...
この道自体に**車線がない**ことから、普通自転車専用道路ではないことがわかります。
...
- 自転車歩行者専用道路: 道路状況でやむを得ない場合を除き、左側端を安全に走行。歩行者の横を通る場合は安全な側方距離を取るか、徐行する
