...
今はレアですが、この写真のような信号無し交差点で **横断歩道標識に歩行者と自転車** があり、かつ、**道路に自転車横断帯**(白実線帯に自転車マーク)がある場合は、
横断しようとする自転車がいる場合も停止して、自転車を横断させる必要があります。

また、自転車横断帯のみの信号無し交差点も存在するようです。道路標識は、青三角形に白自転車と横断帯になるようです。
